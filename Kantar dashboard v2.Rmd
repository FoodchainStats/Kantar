...
cleaned_data_initial <- read.csv("S:/Analysis/Covid-19/Kantar/Current_Week_cleaned_data.csv", stringsAsFactors = F)
...
key_cats <- c("Total Food & Drink","Alcohol","Canned Goods","Dairy Products","Fresh Fish","Fresh Meat","Fresh Poultry+Game","Frozen Fish","Frozen Meat","Frozen Poultry+Game",
              "Frozen Prepared Foods","Fruit+Veg+Salads","Household+Cleaning Products")  
pickerInput(
